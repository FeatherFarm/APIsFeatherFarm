...
function cadastrar(req, res) {
    ...
    usuarioModel.cadastrar(RazaoSocial, Cnpj, Nome_fantasia, Senha, Logradouro, Numero, Bairro, Uf, Cep, Cidade, Nome, Sobrenome, EmailCadastro, Email2Cadastro, Telefone, Telefone2)
        .then(
            function (resultado) {
                res.json(resultado);
            }
